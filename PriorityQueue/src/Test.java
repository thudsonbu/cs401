...
public class Test {
    public static void main(String[] args){
        ...
        PriorityQueue<Person> nameLengthQueue = new PriorityQueue<Person>();
        // add to priority queue
        for (int i = 0; i <  people.length; i++){
            Person addPerson = people[i];
            nameLengthQueue.add(addPerson);
        }
        // poll and peek priority queue
        Person firstPerson = nameLengthQueue.poll();
        System.out.println("\nFirst person is " + firstPerson);
        Person secondPerson = nameLengthQueue.peek();
        System.out.println("Second person is " + secondPerson);
        nameLengthQueue.poll();
        Person thirdPerson = nameLengthQueue.poll();
